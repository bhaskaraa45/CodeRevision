...
import com.bhaskar.aa45.coderevision.MainActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    //if user start the app after login in
    @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!MainActivity.dark){
            parent.setBackgroundColor(getResources().getColor(R.color.grey_bg_login));
        }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(LoginActivity.this, "Error While Login with Google", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
    }
    ...
    public void onResume() {
        super.onResume();
        Objects.requireNonNull(LoginActivity.this.getSupportActionBar()).hide();
    }
